/**
 * End-to-end test: Vercel AI SDK + Tokenash compress()
 *
 * Tests REAL calls through the Vercel AI SDK with Tokenash compression.
 ...
 *
 * Run: TOKENASH_INTEGRATION=1 npx vitest run test/vercel-ai-e2e.test.ts
 */
...
describe.skipIf(!RUN)("E2E: Vercel AI SDK + Tokenash", () => {
  beforeAll(async () => {
  ...
  it("tokenashMiddleware() transparently compresses before LLM call (OpenAI)", { timeout: 30000 }, async () => {
    ...
    // Wrap model with Tokenash middleware
