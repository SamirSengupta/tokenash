 ...
 *
 * Run: TOKENASH_INTEGRATION=1 npx vitest run test/mdx-examples.test.ts
 */
...
const RUN = process.env.TOKENASH_INTEGRATION === "1";

describe.skipIf(!RUN)("MDX Examples: 51-tokenash.mdx", () => {
  beforeAll(async () => {
  ...
  // =====================================================
  // Example 1 from 51-tokenash.mdx: "Compress messages before calling the model"
  // =====================================================
  ...
  // =====================================================
  // Example 2 from 51-tokenash.mdx: "Use as middleware"
  // =====================================================
  it("tokenashMiddleware() with wrapLanguageModel → generateText()", { timeout: 30000 }, async () => {
    const { tokenashMiddleware } = await import("../src/adapters/vercel-ai.js");
    ...
    const model = wrapLanguageModel({
      model: openai("gpt-4o-mini"),
      middleware: tokenashMiddleware({ baseUrl: PROXY_URL }),
    });
  ...
  // =====================================================
  // Example 3 from 51-tokenash.mdx: "Works with any provider" (Anthropic)
  // =====================================================
