/**
 * Tests for expanded TokenashClient — chat.completions, messages, metrics, CCR, etc.
 * Uses mocked proxy (no real server needed).
 */
import { describe, it, expect, vi, beforeEach } from "vitest";
import { TokenashClient } from "../src/client.js";
...
describe("TokenashClient constructor", () => {
...
describe("TokenashClient.health()", () => {
  ...
  it("returns health status", async () => {
    ...
    const client = new TokenashClient({ baseUrl: "http://test:8787" });
...
describe("TokenashClient.proxyStats()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("TokenashClient.getMetrics()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("TokenashClient.getSummary()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("TokenashClient.validateSetup()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("TokenashClient.retrieve()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("TokenashClient.clearCache()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("TokenashClient.compressRaw()", () => {
  beforeEach(() => vi.clearAllMocks());
...
describe("TokenashClient config passthrough", () => {
  beforeEach(() => vi.clearAllMocks());
