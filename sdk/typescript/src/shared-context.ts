 ...
 * Matches Python tokenash.shared_context.SharedContext.
 */

import { TokenashClient } from "./client.js";
import type { TokenashClientOptions, CompressResult } from "./types.js";
...
export interface SharedContextOptions extends TokenashClientOptions {
  model?: string;
  ttl?: number;
  maxEntries?: number;
}
...
export class SharedContext {
  ...
  constructor(options: SharedContextOptions = {}) {
    ...
    this.client = new TokenashClient(clientOptions);
