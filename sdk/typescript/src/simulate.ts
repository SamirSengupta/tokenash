...
import type { TokenashClientOptions } from "./types.js";
import type { SimulationResult } from "./types/models.js";
import type { TokenashConfig } from "./types/config.js";
import { deepCamelCase, deepSnakeCase } from "./utils/case.js";
import { detectFormat, toOpenAI } from "./utils/format.js";

export interface SimulateOptions extends TokenashClientOptions {
  model?: string;
...
export async function simulate(
  ...
  const client = providedClient ?? new TokenashClient(clientOptions);
