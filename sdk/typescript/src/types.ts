/**
 * Core types for the Tokenash TypeScript SDK.
...
export interface CompressOptions {
  ...
  fallback?: boolean;
  retries?: number;
  client?: TokenashClientInterface;
  ...
  /** Integration slug sent as X-Tokenash-Stack (e.g. "adapter_ts_openai"). */
  stack?: string;
}
...
export interface TokenashClientOptions {
  baseUrl?: string;
  apiKey?: string;
  timeout?: number;
  fallback?: boolean;
  retries?: number;
  /** Integration slug sent as X-Tokenash-Stack on every request. */
  stack?: string;
}

export interface TokenashClientInterface {
  compress(
