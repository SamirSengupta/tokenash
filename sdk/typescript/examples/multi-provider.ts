 ...
 *
 * Use the same withTokenash wrapper across different providers.
 * Tokenash compresses identically regardless of which LLM you use.
 *
...
async function main() {
  ...
  const gpt = withTokenash(openai("gpt-4o"));
  ...
  const mini = withTokenash(openai("gpt-4o-mini"));
