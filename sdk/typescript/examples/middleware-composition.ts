 ...
 *
 * Combine tokenashMiddleware with other Vercel AI SDK middlewares.
 * Tokenash compresses first, then other middlewares process the result.
 *
...
async function main() {
  ...
  const model = wrapLanguageModel({
    model: openai("gpt-4o"),
    middleware: [
      tokenashMiddleware(), // compress large context
