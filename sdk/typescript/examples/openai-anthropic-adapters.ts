 ...
 */
import { withTokenash as withTokenashOpenAI } from "tokenash/openai";
import { withTokenash as withTokenashAnthropic } from "tokenash/anthropic";
...
async function main() {
  ...
  if (process.env.OPENAI_API_KEY) {
    ...
    const openai = withTokenashOpenAI(new OpenAI());
  ...
  if (process.env.ANTHROPIC_API_KEY) {
    ...
    const anthropic = withTokenashAnthropic(new Anthropic());
