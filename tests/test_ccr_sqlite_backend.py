...
from tokenash.cache.backends.sqlite import SQLiteBackend
from tokenash.cache.compression_store import CompressionEntry, CompressionStore
...
class TestSQLiteBackend:
    ...
    def test_unknown_json_fields_tolerated(self, db_path):
        """Forward-compat: entries written by a newer tokenash version
...
class TestDefaults:
    ...
    def test_default_backend_is_sqlite(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setenv("TOKENASH_CCR_SQLITE_PATH", str(tmp_path / "d.db"))
    ...
    def test_miss_message_is_actionable(self):
        from tokenash.cache.compression_store import CCR_MISS_MESSAGE
