...
from tokenash.providers.claude import DEFAULT_API_URL as DEFAULT_ANTHROPIC_API_URL  # noqa: E402
from tokenash.providers.codex import DEFAULT_API_URL as DEFAULT_OPENAI_API_URL  # noqa: E402
from tokenash.providers.gemini import DEFAULT_API_URL as DEFAULT_GEMINI_API_URL  # noqa: E402
from tokenash.providers.registry import (  # noqa: E402
    DEFAULT_CLOUDCODE_API_URL,
    DEFAULT_VERTEX_API_URL,
)
from tokenash.proxy.models import ProxyConfig  # noqa: E402
from tokenash.proxy.server import run_server  # noqa: E402
...
class TestBannerUpstreamTargets:
    ...
    def _capture_banner(self, config: ProxyConfig | None = None) -> str:
        ...
        with (
            ...
            patch("tokenash.proxy.server.uvicorn") as mock_uvicorn,
            patch("tokenash.proxy.server.create_app"),
        ):
