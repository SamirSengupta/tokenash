"""Test OpenAI /v1/chat/completions streaming through tokenash proxy backends.

Proves that streaming works end-to-end: client → tokenash proxy → backend → OpenAI API.
