...
``tokenash mcp serve`` writes every compress / retrieve invocation to a
...
``tokenash_compress`` directly.

These tests pin the aggregation logic in
:func:`tokenash.proxy.cost._aggregate_mcp_events`.
"""
