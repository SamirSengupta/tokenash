...
from tokenash.image.tile_optimizer import (
...
class TestOnnxRouter:
    ...
    def test_query_classification(self):
        ...
        from tokenash.image.onnx_router import OnnxTechniqueRouter, Technique
    ...
    def test_full_classify_with_image(self):
        ...
        from tokenash.image.onnx_router import OnnxTechniqueRouter
...
class TestOcrRouting:
    ...
    def test_transcode_replaces_image_with_text(self):
        ...
        from tokenash.image import ImageCompressor
        from tokenash.image.trained_router import Technique
