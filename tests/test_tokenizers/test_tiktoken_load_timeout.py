...
from tokenash.tokenizers import tiktoken_counter as tc
from tokenash.tokenizers.estimator import EstimatingTokenCounter
from tokenash.tokenizers.registry import TokenizerRegistry
...
def test_load_encoding_is_bounded_on_stall(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("TOKENASH_TIKTOKEN_LOAD_TIMEOUT_SECONDS", "0.2")
