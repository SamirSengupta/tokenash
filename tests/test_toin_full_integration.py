...
from tokenash.config import CCRConfig
...
class TestTOINDefaultStoragePath:
    ...
    def test_toin_default_storage_path_exists(self):
        ...
        print("Expected location: ~/.tokenash/toin.json")
        ...
        expected_suffix = ".tokenash/toin.json"
    ...
    def test_tokenash_toin_path_env_var(self):
        """Verify TOKENASH_TOIN_PATH env var overrides default."""
        print("\n" + "=" * 60)
        print("TEST: test_tokenash_toin_path_env_var")
        print("=" * 60)
        ...
        try:
            ...
            print("\n[PASS] TOKENASH_TOIN_PATH env var works correctly")
    ...
    def test_empty_env_var_uses_default(self):
        """Verify empty TOKENASH_TOIN_PATH falls back to default."""
        print("\n" + "=" * 60)
        ...
        try:
            ...
            # Should fall back to default ~/.tokenash/toin.json
            assert ".tokenash/toin.json" in default_path, (
