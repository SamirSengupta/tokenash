...
Covers the fixes in:
- tokenash/memory/adapters/embedders.py (HF env vars, httpx logger)
- tokenash/providers/anthropic.py (warn=False suppresses tiktoken warning)
- tokenash/providers/litellm.py (suppress_debug_info, set_verbose)
- tokenash/transforms/html_extractor.py (trafilatura logger CRITICAL)
"""
...
class TestAnthropicWarnParameter:
    ...
    def test_warn_true_emits_warning_without_client(self):
        ...
        import tokenash.providers.anthropic as _mod
    ...
    def test_registry_uses_warn_false(self):
        ...
        from tokenash.providers import registry as _registry_mod
...
class TestEmbedderLogLevels:
    """tokenash.memory.adapters.embedders must set specific logger levels at import time."""

    def test_huggingface_hub_logger_is_error_or_higher(self):
        """huggingface_hub logger must be silenced to ERROR or above."""
        import tokenash.memory.adapters.embedders  # noqa: F401
...
class TestLiteLLMLogSuppression:
    ...
    def test_litellm_suppress_env_is_set_before_import(self, monkeypatch):
        ...
        sys.modules.pop("tokenash.providers.litellm", None)
        ...
        try:
            importlib.import_module("tokenash.providers.litellm")
        finally:
            sys.modules.pop("tokenash.providers.litellm", None)
            sys.modules.pop("litellm", None)
    ...
    def test_litellm_suppress_debug_info_is_set(self):
        ...
        import tokenash.providers.litellm  # noqa: F401
...
class TestTrafilaturaLogLevel:
    ...
    def test_trafilatura_logger_is_critical(self):
        ...
        import tokenash.transforms.html_extractor  # noqa: F401
