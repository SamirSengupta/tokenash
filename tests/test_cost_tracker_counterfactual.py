...
def test_no_cost_without_tokenash_field():
    """cost_without_tokenash_usd should NOT be in stats (removed to avoid confusion)."""
    from tokenash.proxy.server import CostTracker
    ...
    assert "cost_without_tokenash_usd" not in stats
