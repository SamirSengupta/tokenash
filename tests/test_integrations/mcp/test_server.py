...
These tests verify that Tokenash correctly compresses MCP tool outputs
...
from tokenash.integrations.mcp import (
...
from tokenash.transforms.smart_crusher import strip_ccr_sentinels
...
class TestMCPClientWrapper:
    ...
    async def test_wrapper_compresses_automatically(self, mock_mcp_client):
        ...
        wrapper = TokenashMCPClientWrapper(mock_mcp_client)
...
class TestMCPCustomProfiles:
    ...
    def test_custom_profile(self):
        ...
        compressor = TokenashMCPCompressor(profiles=custom_profiles)
