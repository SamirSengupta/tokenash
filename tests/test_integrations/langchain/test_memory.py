...
Tests cover:
1. TokenashChatMessageHistory - Wrapper for chat message history with compression
...
class TestTokenashChatMessageHistoryInit:
    """Tests for TokenashChatMessageHistory initialization."""
    ...
    def test_init_defaults(self, mock_base_history):
        ...
        with patch("tokenash.integrations.langchain.memory.OpenAIProvider"):
            history = TokenashChatMessageHistory(mock_base_history)
...
class TestTokenashChatMessageHistoryMessages:
    ...
    def test_messages_returns_empty_when_no_messages(self, mock_base_history, mock_provider):
        ...
        history = TokenashChatMessageHistory(mock_base_history, provider=mock_provider)
...
class TestTokenashChatMessageHistoryAddMessage:
...
class TestTokenashChatMessageHistoryConversion:
...
class TestTokenashChatMessageHistoryTokenCounting:
...
class TestTokenashChatMessageHistoryStats:
...
class TestTokenashChatMessageHistoryCompression:
    ...
    def test_apply_compression_calls_pipeline(self, mock_base_history, mock_provider):
        ...
        with patch("tokenash.integrations.langchain.memory.TransformPipeline") as MockPipeline:
...
class TestLangChainNotAvailable:
    ...
    def test_check_raises_import_error(self):
        ...
        from tokenash.integrations.langchain.memory import _check_langchain_available
