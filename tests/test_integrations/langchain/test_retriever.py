...
2. TokenashDocumentCompressor - LangChain BaseDocumentCompressor implementation
...
class TestCompressionMetrics:
    ...
    def test_create_metrics(self):
        ...
        from tokenash.integrations.langchain.retriever import CompressionMetrics
...
class TestTokenashDocumentCompressorInit:
    """Tests for TokenashDocumentCompressor initialization."""
...
class TestTokenashDocumentCompressorCompress:
    ...
    def test_compress_fewer_than_max_documents(self, sample_documents):
        ...
        compressor = TokenashDocumentCompressor(max_documents=10)  # More than 5 docs
    ...
    def test_compress_orders_by_relevance(self, sample_documents):
        ...
        compressor = TokenashDocumentCompressor(max_documents=3)
...
class TestTokenashDocumentCompressorScoring:
...
class TestTokenashDocumentCompressorTokenize:
...
class TestTokenashDocumentCompressorDiversity:
    ...
    def test_select_diverse_empty(self):
        ...
        compressor = TokenashDocumentCompressor(prefer_diverse=True)
...
class TestTokenashDocumentCompressorStats:
...
class TestTokenashDocumentCompressorCallbacks:
...
class TestLangChainNotAvailable:
    ...
    def test_check_raises_import_error(self):
        ...
        from tokenash.integrations.langchain.retriever import _check_langchain_available
