...
2. langchain_memory - TokenashChatMessageHistory
3. langchain_retriever - TokenashDocumentCompressor
4. langchain_agents - TokenashToolWrapper
...
class TestProviderDetection:
    ...
    def test_detect_openai_provider(self):
        ...
        from tokenash.integrations.langchain.providers import detect_provider
    ...
    def test_get_tokenash_provider_openai(self):
        """Get OpenAIProvider for OpenAI model."""
        from tokenash.integrations.langchain.providers import get_tokenash_provider
        ...
        provider = get_tokenash_provider(mock_model)
        assert isinstance(provider, OpenAIProvider)

    def test_get_tokenash_provider_anthropic(self):
    ...
    def test_get_model_name_from_langchain(self):
        ...
        from tokenash.integrations.langchain.providers import get_model_name_from_langchain
...
class TestTokenashChatMessageHistory:
    """Tests for TokenashChatMessageHistory memory wrapper."""
    ...
    def test_init(self):
        ...
        wrapper = TokenashChatMessageHistory(
            mock_history,
    ...
    def test_add_message_delegates(self):
        ...
        wrapper = TokenashChatMessageHistory(mock_history)
...
class TestTokenashDocumentCompressor:
    """Tests for TokenashDocumentCompressor retriever integration."""

    def test_init(self):
        """Initialize with defaults."""
        from tokenash.integrations.langchain.retriever import TokenashDocumentCompressor
    ...
    def test_compress_passthrough_under_limit(self):
        ...
        compressor = TokenashDocumentCompressor(max_documents=10)
    ...
    def test_compress_reduces_to_max(self):
        ...
        compressor = TokenashDocumentCompressor(max_documents=2)
    ...
    def test_compress_prefers_relevant(self):
        ...
        compressor = TokenashDocumentCompressor(max_documents=1)
...
class TestTokenashToolWrapper:
    """Tests for TokenashToolWrapper agent integration."""

    def test_init(self):
        """Initialize wrapper."""
        from tokenash.integrations.langchain.agents import TokenashToolWrapper

        mock_tool = MagicMock()
        mock_tool.name = "test_tool"
        mock_tool.description = "A test tool"

        wrapper = TokenashToolWrapper(mock_tool)
    ...
    def test_call_passthrough_small_output(self):
        ...
        wrapper = TokenashToolWrapper(mock_tool, min_chars_to_compress=1000)
    ...
    def test_call_compresses_large_json(self):
        ...
        wrapper = TokenashToolWrapper(mock_tool, min_chars_to_compress=100)
        result = wrapper("query")
    ...
    def test_wrap_tools_with_tokenash(self):
        """Wrap multiple tools at once."""
        from tokenash.integrations.langchain.agents import wrap_tools_with_tokenash
        ...
        wrapped = wrap_tools_with_tokenash(tools)
    ...
    def test_metrics_collector(self):
        ...
        from tokenash.integrations.langchain.agents import (
            TokenashToolWrapper,
        ...
        wrapper = TokenashToolWrapper(mock_tool, metrics_collector=collector)
        wrapper("query")
...
class TestTokenashLangSmithCallbackHandler:
    """Tests for LangSmith integration."""

    def test_init(self):
        """Initialize handler."""
        from tokenash.integrations.langchain.langsmith import (
            TokenashLangSmithCallbackHandler,
        )

        handler = TokenashLangSmithCallbackHandler(auto_update_runs=False)

        assert handler._auto_update is False
        assert handler._pending_metrics == {}

    def test_set_tokenash_metrics(self):
    ...
    def test_get_run_metrics(self):
        ...
        handler = TokenashLangSmithCallbackHandler(auto_update_runs=False)
        handler._run_metrics["run-1"] = {"tokenash.tokens_saved": 100}

        metrics = handler.get_run_metrics("run-1")
        assert metrics["tokenash.tokens_saved"] == 100
    ...
    def test_get_summary(self):
        ...
        handler._run_metrics = {
            "run-1": {"tokenash.tokens_saved": 100, "tokenash.savings_percent": 20},
            "run-2": {"tokenash.tokens_saved": 200, "tokenash.savings_percent": 30},
        }
...
class TestStreamingMetricsTracker:
    ...
    def test_init(self):
        """Initialize tracker."""
        from tokenash.integrations.langchain.streaming import StreamingMetricsTracker
    ...
    def test_streaming_metrics_callback(self):
        ...
        from tokenash.integrations.langchain.streaming import StreamingMetricsCallback
    ...
    def test_track_streaming_response(self):
        ...
        from tokenash.integrations.langchain.streaming import track_streaming_response
...
class TestAutoDetectProviderInChatModel:
    """Tests for auto_detect_provider in TokenashChatModel."""
    ...
    def test_auto_detect_enabled_by_default(self):
        ...
        model = TokenashChatModel(mock_model)
    ...
    def test_auto_detect_can_be_disabled(self):
        ...
        model = TokenashChatModel(mock_model, auto_detect_provider=False)
