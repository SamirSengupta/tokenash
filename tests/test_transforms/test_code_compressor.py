...
from tokenash.transforms.code_compressor import (
    CodeAwareCompressor,
...
class TestFallbackCompression:
    ...
    def test_fallback_when_tree_sitter_unavailable(self, default_config):
        ...
        with patch(
            "tokenash.transforms.code_compressor._check_tree_sitter_available",
            return_value=False,
        ):
            compressor = CodeAwareCompressor(default_config)
    ...
    def test_fallback_preserves_structure(self, default_config):
        ...
        with (
            ...
            patch(
                "tokenash.transforms.kompress_compressor.is_kompress_available",
                return_value=False,
            ),
        ):
            compressor = CodeAwareCompressor(default_config)
...
class TestRealASTRuns:
    ...
    def test_get_parser_returns_stock_node_api(self):
        ...
        from tokenash.transforms.code_compressor import _get_parser
    ...
    def test_check_tree_sitter_available_verifies_real_parse(self):
        ...
        import tokenash.transforms.code_compressor as cc
    ...
    def test_get_node_text_uses_utf8_byte_offsets(self):
        ...
        from tokenash.transforms.code_compressor import _get_node_text, _get_parser
