...
class TestExcludeTools:
    ...
    def test_is_tool_excluded_helper(self):
        ...
        from tokenash.config import is_tool_excluded
    ...
    def test_bash_not_in_default_exclude_tools(self):
        ...
        """
        from tokenash.config import DEFAULT_EXCLUDE_TOOLS
...
class TestSmartCrusherFallback:
    ...
    def test_smart_crusher_with_no_savings_triggers_kompress_fallback(self, router, monkeypatch):
        ...
        ``tokenash._core`` extension or an LLM round-trip.
        """
        from unittest.mock import MagicMock

        import tokenash.transforms.content_router as crm
        from tokenash.transforms.smart_crusher import CrushResult
    ...
    def test_smart_crusher_json_compresses_directly(self, router, monkeypatch):
        ...
        ``tokenash._core`` extension in test environments.
        """
        import json
        from unittest.mock import MagicMock
