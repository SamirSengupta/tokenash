...
was retired in favor of the Rust-backed shim (`tokenash._core` via PyO3).
...
`crates/tokenash-core/tests`. Public-API tests (anything calling
...
def _cfg_below_threshold():
    ...
    from tokenash.transforms.diff_compressor import DiffCompressorConfig
...
class TestRoutingGapDetectorScanWindow:
    ...
    def test_detect_picks_up_diff_after_long_commit_message(self):
        from tokenash.transforms.content_detector import (
            ContentType,
            detect_content_type,
        )
