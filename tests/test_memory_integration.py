"""Integration tests for Tokenash Memory System.
...
class TestMemoryIntegration:
    ...
    def test_optimized_tools_have_extraction_fields(self):
        ...
        from tokenash.memory.tools import get_memory_tools, get_memory_tools_optimized
    ...
    def test_wrapper_uses_correct_tools(self, openai_client, temp_db_path, user_id):
        ...
        from tokenash.memory import with_memory_tools
    ...
    def test_extraction_prompt_injection(self, openai_client, temp_db_path, user_id):
        ...
        from tokenash.memory import with_memory_tools
        from tokenash.memory.backends.local import LocalBackend, LocalBackendConfig
        from tokenash.memory.extraction import EXTRACTION_SYSTEM_PROMPT
    ...
    async def test_local_backend_pre_extraction(self, temp_db_path, user_id):
        ...
        from tokenash.memory.adapters.graph_models import RelationshipDirection
    ...
    async def test_memory_system_tool_dispatch(self, temp_db_path, user_id):
        ...
        from tokenash.memory.backends.local import LocalBackend, LocalBackendConfig
        from tokenash.memory.system import MemorySystem
    ...
    def test_full_flow_save_then_search(self, openai_client, temp_db_path, user_id):
        ...
        save_response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "user",
                    "content": "Remember this: My favorite programming language is Rust and I'm working on a CLI tool called tokenash.",
                },
            ],
        )
...
class TestExtractionPrompts:
    ...
    def test_extraction_prompts_exist_and_valid(self):
        ...
        from tokenash.memory.extraction import (
...
class TestWrapperToolsModule:
    ...
    def test_wrapper_tools_imports(self):
        ...
        from tokenash.memory.wrapper_tools import (
    ...
    def test_with_memory_tools_accepts_optimized_param(self):
        ...
        from tokenash.memory.wrapper_tools import with_memory_tools
