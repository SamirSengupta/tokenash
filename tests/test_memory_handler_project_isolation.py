...
from tokenash.memory import storage_router as sr_mod
...
def patch_backend(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import tokenash.memory.backends.local as _local_mod
...
# (x-tokenash-project-id / x-tokenash-cwd / system-prompt cwd:) must
