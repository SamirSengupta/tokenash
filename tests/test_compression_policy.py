...
``tokenash_core::compression_policy::CompressionPolicy``. These tests
...
``crates/tokenash-core/src/compression_policy.rs``.
"""
...
from tokenash.transforms.compression_policy import (
    CompressionPolicy,
    policy_default_payg,
    policy_for_mode,
)
...
class TestRustParityFieldMap:
    ...
    ``crates/tokenash-core/src/compression_policy.rs``. When you add a
    ...
    def test_field_set_matches_rust(self):
        ...
        assert actual_fields == expected_fields, (
            ...
            f"Update both `tokenash/transforms/compression_policy.py` "
            f"and `crates/tokenash-core/src/compression_policy.rs` in "
            f"the same commit."
        )
...
class TestNetCostFormula:
    ...
    ``crates/tokenash-core/src/compression_policy.rs`` assert the
