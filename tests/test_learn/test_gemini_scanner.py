...
from tokenash.learn.models import ProjectInfo, Recommendation, RecommendationTarget
from tokenash.learn.scanner import GeminiScanner
from tokenash.learn.writer import GeminiWriter
...
class TestToolNameNormalization:
    def test_all_known_names(self):
        from tokenash.learn._shared import normalize_tool_name
