"""Integration tests for tokenash learn — using real session data.
...
from tokenash.learn.analyzer import SessionAnalyzer
from tokenash.learn.models import (
    ProjectInfo,
    Recommendation,
    RecommendationTarget,
)
from tokenash.learn.scanner import _greedy_path_decode
from tokenash.learn.writer import ClaudeCodeWriter, CodexWriter
...
class TestFalsePositiveFiltering:
    ...
    def test_sed_output_not_error(self):
        ...
        from tokenash.learn.scanner import is_error_content
...
class TestClaudeCodeIntegration:
    ...
    def test_scanner_discovers_projects(self):
        from tokenash.learn.scanner import ClaudeCodeScanner
    ...
    def test_dry_run_writes_nothing(self):
        ...
        with patch("tokenash.learn.analyzer._call_llm", return_value=mock_response):
            sessions = scanner.scan_project(best)
...
class TestCodexIntegration:
    ...
    def test_scanner_discovers_sessions(self):
        from tokenash.learn.scanner import CodexScanner
