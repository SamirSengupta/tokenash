...
from tokenash.learn.base import LearnPlugin
from tokenash.learn.registry import (
    auto_detect_plugins,
...
from tokenash.learn.scanner import ConversationScanner
...
class TestPluginCreateWriter:
    def test_all_plugins_create_valid_writers(self):
        from tokenash.learn.writer import ContextWriter
