...
def get_tracked_memory() -> dict:
    ...
    from tokenash.memory.tracker import MemoryTracker
...
class TestMemorySystemIntegration:
    ...
    async def test_graph_store_memory_growth(self):
        ...
        from tokenash.memory.adapters.graph_models import Entity, Relationship
        from tokenash.memory.tracker import MemoryTracker
...
class TestCCRIntegration:
    ...
    def reset_stores(self):
        ...
        from tokenash.ccr.batch_store import reset_batch_context_store
        from tokenash.memory.tracker import MemoryTracker
    ...
    def test_compression_store_memory_growth(self):
        ...
        from tokenash.cache.compression_store import CompressionStore
        from tokenash.memory.tracker import MemoryTracker
    ...
    def test_batch_context_store_memory_growth(self):
        ...
        from tokenash.ccr.batch_store import (
            BatchContext,
            BatchContextStore,
            BatchRequestContext,
        )
...
class TestProxyMemoryIntegration:
    ...
    def test_real_api_calls_memory_tracking(self, api_key):
        ...
        from tokenash.cache.compression_store import CompressionStore
        from tokenash.ccr.batch_store import BatchContextStore
...
class TestCombinedMemoryTracking:
    ...
    async def test_all_components_memory_tracking(self):
        ...
        from tokenash.cache.compression_store import CompressionStore
        from tokenash.ccr.batch_store import BatchContext, BatchContextStore, BatchRequestContext
        from tokenash.memory.adapters.graph import InMemoryGraphStore
        from tokenash.memory.adapters.graph_models import Entity, Relationship
        from tokenash.memory.adapters.hnsw import HNSWVectorIndex
        from tokenash.memory.models import Memory
