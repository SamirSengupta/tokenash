...
class TestRereadDetection:
    ...
    def test_reread_in_total_and_dict(self):
        ...
        from tokenash.config import WasteSignals
...
# --- Anthropic tool_result content blocks (SamirSengupta/tokenash#813) ---
...
class TestCallArgMatchReread:
    ...
    def test_canonical_call_key_normalizes_serialization(self):
        ...
        from tokenash.parser import _canonical_call_key
