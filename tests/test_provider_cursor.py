...
from tokenash.providers.cursor import build_proxy_targets, render_setup_lines
from tokenash.providers.cursor.install import build_install_env


def test_cursor_proxy_targets_use_local_tokenash_proxy() -> None:
