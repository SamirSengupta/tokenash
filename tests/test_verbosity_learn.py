"""Tests for tokenash.learn.verbosity — behavioral signal extraction."""
...
from tokenash.learn.verbosity import (
    VerbositySignals,
    analyze,
    extract_signals,
    recommend_level,
...
class TestAnalyze:
    ...
    def test_profile_roundtrip(self, tmp_path):
        from tokenash.learn.verbosity import VerbosityProfile
