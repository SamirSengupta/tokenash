...
from tokenash.proxy.request_logger import RequestLogger
from tokenash.proxy.server import TokenashProxy


def _build_proxy_with_real_logger(*, log_full_messages: bool) -> TokenashProxy:
    """Build a TokenashProxy with mocks for everything except the request logger,
