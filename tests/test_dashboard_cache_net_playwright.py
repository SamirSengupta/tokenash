...
and ``prefix_cache.prefix_freeze`` (built in ``tokenash/proxy/cost.py``)
...
def _open_dashboard(page: Page, stats: dict) -> None:
    ...
    page.goto("http://tokenash.local/dashboard")
    page.wait_for_load_state("networkidle")


def test_dashboard_renders_compression_vs_cache_net_metrics() -> None:
    artifact_dir = os.environ.get("TOKENASH_PLAYWRIGHT_ARTIFACT_DIR")
