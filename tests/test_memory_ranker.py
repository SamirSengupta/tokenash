"""Tests for :class:`tokenash.proxy.memory_ranker.MemoryRanker` +
:class:`RecencyBoostRanker`.

Pre-this-PR Tokenash ranked memory candidates by pure cosine
...
from tokenash.proxy.memory_ranker import (
    MemoryCandidate,
    RecencyBoostRanker,
)
