"""Real-world integration tests for Strands TokenashStrandsModel.
...
# ============================================================================
# Test Class for TokenashStrandsModel
# ============================================================================


@pytest.mark.skipif(SKIP_BEDROCK, reason="AWS credentials not available")
@pytest.mark.skipif(not STRANDS_AVAILABLE, reason="strands-agents not installed")
class TestTokenashStrandsModelReal:
    """Real-world integration tests for TokenashStrandsModel with Bedrock."""
    ...
    def wrapped_model(self, base_bedrock_model):
        """Create a TokenashStrandsModel wrapping the Bedrock model."""
    ...
    def test_model_wrapper_basic_response(self, wrapped_model):
        ...
        result = agent("Say 'Hello, Tokenash!' and nothing else.")
    ...
    def test_model_wrapper_custom_config(self, base_bedrock_model):
        """Test that custom TokenashConfig is applied."""
        from tokenash import TokenashConfig
        from tokenash.integrations.strands import TokenashStrandsModel

        custom_config = TokenashConfig()
        ...
        assert wrapped.tokenash_config is custom_config
        assert wrapped.tokenash_config.smart_crusher.min_tokens_to_crush == 50
    ...
    def test_model_wrapper_provider_detection(self, base_bedrock_model):
        ...
        assert wrapped._tokenash_provider is not None
        assert isinstance(wrapped._tokenash_provider, AnthropicProvider)
