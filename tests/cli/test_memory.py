...
class TestMemoryList:
    """Tests for 'tokenash memory list' command."""
...
class TestMemoryShow:
    """Tests for 'tokenash memory show' command."""
...
class TestMemoryStats:
    """Tests for 'tokenash memory stats' command."""
...
class TestMemoryEdit:
    """Tests for 'tokenash memory edit' command."""
...
class TestMemoryDelete:
    """Tests for 'tokenash memory delete' command."""
...
class TestMemoryPrune:
    """Tests for 'tokenash memory prune' command."""
...
class TestMemoryPurge:
    """Tests for 'tokenash memory purge' command."""
