...
@contextmanager
def _capture_tokenash_retrieve_events():
    events: list[dict[str, Any]] = []
    prefix = "event=tokenash_retrieve "
    ...
    logger = logging.getLogger("tokenash.cache.compression_store")
...
def test_retrieve_logs_payload_preview():
    ...
    with _capture_tokenash_retrieve_events() as events:
...
class TestCompressionStoreFeedback:
    ...
    @patch("tokenash.cache.compression_feedback.get_compression_feedback")
    @patch("tokenash.telemetry.get_telemetry_collector")
    @patch("tokenash.telemetry.toin.get_toin")
