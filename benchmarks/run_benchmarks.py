#!/usr/bin/env python3
"""CLI runner for Tokenash benchmark suite.

This script provides a convenient interface for running benchmarks and
generating reports. It wraps pytest-benchmark with Tokenash-specific
...
def generate_markdown_report(
    ...
    # Header
    lines.append("# Tokenash SDK Benchmark Report")
    lines.append("")
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Run Tokenash SDK benchmarks",
