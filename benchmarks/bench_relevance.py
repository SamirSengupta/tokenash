"""Relevance scorer benchmarks for Tokenash SDK.
...
class TestBM25Benchmarks:
    ...
    def scorer(self):
        ...
        from tokenash.relevance.bm25 import BM25Scorer
...
class TestHybridBenchmarks:
    ...
    def scorer_fallback(self):
        ...
        from tokenash.relevance.bm25 import BM25Scorer
        from tokenash.relevance.hybrid import HybridScorer
...
class TestScorerFactoryBenchmarks:
    ...
    def test_create_bm25_scorer(self, benchmark):
        ...
        """
        from tokenash.relevance import create_scorer
...
class TestRelevanceInSmartCrusher:
    ...
    def crusher_with_bm25(self, smart_crusher_config):
        ...
        from tokenash.config import RelevanceScorerConfig
...
def _check_embedding_available() -> bool:
    ...
    try:
        from tokenash.relevance.embedding import EmbeddingScorer
