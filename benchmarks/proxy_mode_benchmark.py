...
def _print_real_harness() -> None:
    ...
    print("  1) Start proxy in cache mode:  TOKENASH_MODE=cache tokenash proxy --port 8787")
    print("  2) Start proxy in token mode:  TOKENASH_MODE=token tokenash proxy --port 8787")
...
def main() -> None:
    logging.getLogger("tokenash").setLevel(logging.WARNING)
