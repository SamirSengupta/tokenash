...
-- This table matches every field the beacon code writes in tokenash/telemetry/beacon.py
...
CREATE INDEX IF NOT EXISTS idx_ptv2_version ON proxy_telemetry_v2(tokenash_version);
