...
- **Repository:** `github.com/JerrettDavis/tokenash`
- **License:** Apache 2.0
...
This specification is the **canonical source of truth** for Tokenash behavior:
...
```bash
# Clone repository
git clone https://github.com/JerrettDavis/tokenash.git
cd tokenash
