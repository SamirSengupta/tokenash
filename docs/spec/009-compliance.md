...
1. **No prompt logging by default** — Tokenash never logs prompt content unless explicitly configured
...
5. **No telemetry to Tokenash project** — No data sent to external servers without explicit opt-in
...
- Tokenash acts as a passthrough proxy
