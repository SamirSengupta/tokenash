...
This specification is the **canonical source of truth** for how Tokenash is designed to behave. It serves:

1. **New contributors** — One place to understand how Tokenash works
...
|---|---------|:------:|-------------|
| 001 | [Vision](001-vision.md) | done | What Tokenash is, what it is not |
...
- A **Python package** (`tokenash`) with proxy, SDK, and CLI
- A **TypeScript SDK** (`@tokenash/sdk`) for Node.js
