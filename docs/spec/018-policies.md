...
| Header | Description |
|--------|-------------|
| `X-Tokenash-Compress` | Override compression (true/false) |
| `X-Tokenash-Mode` | Override mode (passthrough/compress/learn) |
| `X-Tokenash-Cache` | Override cache (true/false) |
