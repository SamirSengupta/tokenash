...
**Context:** Tokenash could be implemented as an SDK that users import, or as a network proxy.
...
**Context:** Tokenash needs to store compression cache, savings history, memory graphs.
