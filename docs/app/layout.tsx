...
// custom domain).
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://tokenash-docs.vercel.app';

export const metadata: Metadata = {
  title: {
    default: 'Tokenash — Context Optimization Layer for AI Agents',
    template: '%s | Tokenash',
  },
  description:
  ...
  openGraph: {
    type: 'website',
    siteName: 'Tokenash',
    title: 'Tokenash — Context Optimization Layer for AI Agents',
    description:
