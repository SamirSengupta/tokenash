...
const integrations: {
...
}[] = [
  {
    ...
    code: 'from tokenash.integrations.langchain import TokenashChatModel\nllm = TokenashChatModel(ChatOpenAI())',
    lang: 'python',
    href: '/docs/langchain',
  },
  {
    ...
    code: 'from tokenash.integrations.agno import TokenashAgnoModel\nmodel = TokenashAgnoModel(Claude())\nagent = Agent(model=model)',
    lang: 'python',
    href: '/docs/agno',
  },
  {
    ...
    code: 'from tokenash.integrations.strands import TokenashStrandsModel\nmodel = TokenashStrandsModel(...)\nagent = Agent(model=model)',
    lang: 'python',
    href: '/docs/strands',
  },
  {
    ...
    code: 'tokenash mcp install && claude',
    lang: 'bash',
    href: '/docs/mcp',
  },
  {
  ...
  },
  {
    title: 'Vercel AI SDK',
    description:
      'One-liner withTokenash() or tokenashMiddleware() for any Vercel AI SDK model.',
    code: "import { withTokenash } from 'tokenash/vercel-ai'\nconst model = withTokenash(openai('gpt-4o'))",
    lang: 'typescript',
    href: '/docs/vercel-ai-sdk',
  },
];
