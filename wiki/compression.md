...
Tokenash's Universal Compression module provides intelligent, automatic compression with ML-based content detection and structure preservation.
...
```python
from tokenash.compression import UniversalCompressorConfig
...
config = UniversalCompressorConfig(
    ...
    # installed via `tokenash[ml]` and configured separately.)
...
```python
from tokenash.compression.handlers.json_handler import JSONStructureHandler
...
```python
from tokenash.compression.handlers.code_handler import CodeStructureHandler
...
```python
from tokenash.compression import UniversalCompressor
...
```python
from tokenash.compression import UniversalCompressor
from tokenash.compression.detector import ContentType
from tokenash.compression.handlers.base import BaseStructureHandler, HandlerResult
...
pip install "tokenash[magika]"

# With LLMLingua compression
pip install "tokenash[llmlingua]"

# With AST-based code handling
pip install "tokenash[code]"
