...
For coding tasks, Tokenash provides **standalone text compression utilities** that applications can use explicitly. These are **opt-in** — they're not applied automatically, giving you full control over when and how to compress text content.
...
```python
from tokenash.transforms import SearchCompressor
...
```python
from tokenash.transforms import LogCompressor
...
```python
from tokenash.transforms import TextCompressor
...
```python
from tokenash.transforms import detect_content_type, ContentType
...
```python
from tokenash.transforms import SearchCompressor, SearchCompressorConfig
