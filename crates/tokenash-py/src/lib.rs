//! PyO3 bindings for tokenash-core. Exposed to Python as `tokenash._core`.
//!
...
//! `tokenash.transforms._rust_diff_compressor.RustBackedDiffCompressor`,
...
/// Mirror of `tokenash.transforms.diff_compressor.DiffCompressorConfig`.
...
/// compatibility.
#[pyclass(name = "DiffCompressorConfig", module = "tokenash._core")]
#[derive(Clone)]
...
/// Mirror of `tokenash.transforms.diff_compressor.DiffCompressionResult`.
...
#[pyclass(name = "DiffCompressionResult", module = "tokenash._core")]
...
#[pyclass(name = "DiffCompressorStats", module = "tokenash._core")]
...
/// Mirror of `tokenash.transforms.diff_compressor.DiffCompressor`. The
/// Python adapter wraps this in `RustBackedDiffCompressor` so
/// `ContentRouter` can swap backends transparently.
#[pyclass(name = "DiffCompressor", module = "tokenash._core")]
...
/// Mirror of `tokenash.transforms.smart_crusher.SmartCrusherConfig`.
...
#[pyclass(name = "SmartCrusherConfig", module = "tokenash._core")]
#[derive(Clone)]
...
/// Mirror of `tokenash.transforms.smart_crusher.CrushResult`. Read-only;
...
#[pyclass(name = "CrushResult", module = "tokenash._core")]
...
/// Mirror of `tokenash.transforms.smart_crusher.SmartCrusher`.
///
...
#[pyclass(name = "SmartCrusher", module = "tokenash._core")]
    ...
    fn with_compaction_format(
        ...
        match RustSmartCrusher::with_compaction_format(cfg, format_name) {
            ...
            None => Err(pyo3::exceptions::PyValueError::new_err(format!(
                ...
                tokenash_core::transforms::smart_crusher::compaction::CompactionStage::SUPPORTED_FORMAT_NAMES.join(", ")
            ))),
        }
    }
...
/// Mirror of `tokenash.transforms.content_detector.DetectionResult`.
///
...
#[pyclass(name = "DetectionResult", module = "tokenash._core")]
#[derive(Clone)]
...
/// `tokenash/transforms/content_router.py`).
///
...
/// Score a line against the default Tokenash keyword detector.
///
...
//
// Mirrors `tokenash.transforms.search_compressor.SearchCompressor` so the
...
#[pyclass(name = "SearchCompressorConfig", module = "tokenash._core")]
#[derive(Clone)]
...
#[pyclass(name = "SearchCompressionResult", module = "tokenash._core")]
...
#[pyclass(name = "SearchCompressor", module = "tokenash._core")]
...
impl PySearchCompressor {
    ...
    fn compress(
        ...
        let (result, stats) = py.allow_threads(move || {
            let store = tokenash_core::ccr::InMemoryCcrStore::new();
            let (r, s) = self
                .inner
...
//
// Mirrors `tokenash.transforms.log_compressor.LogCompressor`. Same CCR
// pattern as search_compressor: Rust emits a `cache_key`, Python shim
// writes the original to the production `CompressionStore`.

#[pyclass(name = "LogCompressorConfig", module = "tokenash._core")]
#[derive(Clone)]
...
#[pyclass(name = "LogCompressionResult", module = "tokenash._core")]
...
#[pyclass(name = "LogCompressor", module = "tokenash._core")]
...
//
// Mirrors `tokenash.transforms.tag_protector.{protect_tags,restore_tags,
...
/// `crates/tokenash-proxy` binary would sit in front of Python; that
/// binary is not deployed by the CLI (`tokenash proxy`,
/// `tokenash wrap codex`). This binding lets the Python proxy call
...
///   to `tokenash_core::transforms::live_zone::DEFAULT_MODEL`.
///
/// # Returns
/// `(body, modified)`:
...
fn compress_openai_responses_live_zone(
    ...
    let model_str = if model.is_empty() {
        tokenash_core::transforms::live_zone::DEFAULT_MODEL
    } else {
        model
    };
...
#[pyclass(name = "TextCrusherConfig", module = "tokenash._core")]
#[derive(Clone)]
...
#[pyclass(name = "TextCrusherResult", module = "tokenash._core")]
...
#[pyclass(name = "TextCrusher", module = "tokenash._core")]
...
fn _core(m: &Bound<'_, PyModule>) -> PyResult<()> {
    // Bridge Rust diagnostics into Python's `logging`. tokenash-core emits
    ...
    // `tokenash_core.transforms.magika_detector`), which is what lands in
