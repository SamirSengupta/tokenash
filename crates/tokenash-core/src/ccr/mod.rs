...
//! end-to-end.
//!
//! Mirrors the semantics of Python's [`CompressionStore`] (`tokenash/
...
//!
//! [`CompressionStore`]: https://github.com/SamirSengupta/tokenash/blob/main/tokenash/cache/compression_store.py
...
pub fn compute_key(payload: &[u8]) -> String {
    ...
    // (`[a-f0-9]{24}`) — see `tokenash/ccr/tool_injection.py:211`.
...
/// calls `tokenash_retrieve`. Format is intentionally fixed across
