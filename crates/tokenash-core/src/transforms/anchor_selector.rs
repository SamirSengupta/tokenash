...
//!
//! Direct port of `tokenash/transforms/anchor_selector.py`. Used by
...
// ============================================================================
// Configuration (Python `tokenash/config.py:294` AnchorConfig)
// ============================================================================

/// Configuration for dynamic anchor allocation.
///
/// Direct port of Python `AnchorConfig` (`tokenash/config.py:294-348`).
