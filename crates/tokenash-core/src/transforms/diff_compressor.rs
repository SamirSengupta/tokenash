//! Unified-diff compressor — Rust port of `tokenash.transforms.diff_compressor`.
//!
...
/// Priority patterns matching `tokenash.transforms.error_detection.PRIORITY_PATTERNS_DIFF`:
...
/// `tokenash.cache.compression_store.CompressionStore.store`.
