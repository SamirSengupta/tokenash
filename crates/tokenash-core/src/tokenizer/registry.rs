...
//!
//! Mirrors `MODEL_PATTERNS` in `tokenash/tokenizers/registry.py`. Three
...
///
/// Patterns and ordering match `tokenash.tokenizers.registry.MODEL_PATTERNS`
...
///
/// ```no_run
/// use tokenash_core::tokenizer::try_register_hf;
