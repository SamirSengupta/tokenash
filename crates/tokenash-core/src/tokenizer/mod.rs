//! Token counting for Tokenash transforms.
//!
//! Mirrors the public surface of the Python `tokenash.tokenizers` package:
...
//!
//! # What this is NOT
//! - Not used by `tokenash-proxy` yet (Stage 2 is library-only; no production
//!   wiring).
