...
//! the Anthropic Messages spec (and the Tokenash realignment guide
//! §5.1) requires.
//!
...
use bytes::Bytes;
use tokenash_proxy::sse::anthropic::{AnthropicStreamState, StreamStatus};
...
#[allow(dead_code)]
fn _ref_event() -> tokenash_proxy::sse::SseEvent {
    tokenash_proxy::sse::SseEvent {
        event_name: None,
