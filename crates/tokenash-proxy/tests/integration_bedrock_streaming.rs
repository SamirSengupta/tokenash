...
async fn bedrock_proxy(
    upstream: &MockServer,
    customize: impl FnOnce(&mut tokenash_proxy::Config),
) -> common::ProxyHandle {
...
async fn usage_extracted_from_translated_stream() {
    ...
    use tokenash_proxy::sse::anthropic::AnthropicStreamState;
    use tokenash_proxy::sse::framing::SseFramer;
