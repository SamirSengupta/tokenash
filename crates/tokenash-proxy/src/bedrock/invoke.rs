...
fn run_anthropic_compression(
    ...
    let outcome = compress_anthropic_request(
        ...
        tokenash_core::auth_mode::AuthMode::OAuth,
        request_id,
    );
    match outcome {
...
mod tests {
    ...
    fn collect_signed_headers_strips_client_managed() {
        ...
        headers.insert("x-tokenash-mode", "live".parse().unwrap());
        ...
        assert!(!names.contains(&"x-tokenash-mode"));
