...
This directory contains examples demonstrating Tokenash's capabilities.
...
AWS Strands Agents + Bedrock integration demo. Showcases two Tokenash integration patterns:

1. **TokenashHookProvider** - Compresses tool outputs in real-time
