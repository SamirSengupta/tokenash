"""Demonstrate Tokenash compression on LangChain tool outputs.

This script shows EXACTLY what Tokenash does to large tool outputs:
...
from tokenash.transforms import SmartCrusher
...
def main():
    ...
    print("\n" + "=" * 70)
    print("TOKENASH SMARTCRUSHER: BEFORE/AFTER COMPRESSION")
    print("=" * 70)
    print("""
This demonstrates how Tokenash's SmartCrusher compresses large tool outputs.
