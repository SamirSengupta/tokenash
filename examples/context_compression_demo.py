...
Tests REAL Tokenash compression on realistic retriever tool outputs.
...
def main() -> None:
    print("=" * 70)
    print("Context Compression Demo (Real Tokenash, No Mocks)")
    print("=" * 70)
    ...
    # --- Compress with REAL Tokenash ---
    from tokenash import compress

    print("\nCompressing with Tokenash (real compress() call)...")
    ...
    print(f"  {'07-Tokenash Compression':<35} {hr_tokens:<10} {hr_pct:<10} {'No':<18} {'$0'}")
