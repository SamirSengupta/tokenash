...
def test_parse_headers_mixed_case_keys(pricing: Pricing) -> None:
    headers = {
        "X-Tokenash-Tokens-Before": "800",
        "X-TOKENASH-TOKENS-AFTER": "200",
        "X-Tokenash-Cached": "TRUE",
    }
    s = parse_savings_headers(headers, pricing)
...
def test_response_hook_noop_when_no_tokenash_headers(pricing: Pricing) -> None:
    store = SavingsStore()
