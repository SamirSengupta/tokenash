...
def main() -> None:
    ...
    versions = {
        ...
        "plugins/tokenash-agent-hooks/.claude-plugin/plugin.json": _read_json_version(
            ROOT / "plugins/tokenash-agent-hooks/.claude-plugin/plugin.json"
        ),
        "plugins/tokenash-agent-hooks/.github/plugin/plugin.json": _read_json_version(
