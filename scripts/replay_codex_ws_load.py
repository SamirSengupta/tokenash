...
os.environ.setdefault("TOKENASH_DISABLE_TELEMETRY", "true")
os.environ.setdefault("TOKENASH_REQUIRE_RUST_CORE", "false")
...
def boot_proxy():
    """Build a TokenashProxy instance with optimize=True so the compression
