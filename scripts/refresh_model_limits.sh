...
# used by `crates/tokenash-proxy/src/compression/model_limits.rs`.
#
...
DEST="$REPO_ROOT/crates/tokenash-proxy/data/model_prices_and_context_window.json"
...
echo "Updated $DEST"
echo "Run 'cargo test -p tokenash-proxy --lib compression::model_limits' to verify."
