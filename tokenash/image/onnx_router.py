...
- SamirSengupta/technique-router-onnx (~32 MB)
- SamirSengupta/siglip-image-encoder-onnx (~95 MB)
"""
...
from tokenash.image.trained_router import ImageSignals, RouteDecision, Technique
from tokenash.onnx_runtime import create_cpu_session_options, hf_hub_download_local_first

logger = logging.getLogger(__name__)

_TECHNIQUE_ROUTER_REPO = "SamirSengupta/technique-router-onnx"
_SIGLIP_ENCODER_REPO = "SamirSengupta/siglip-image-encoder-onnx"
