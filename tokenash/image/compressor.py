...
This is the main entry point for image compression in Tokenash.
It automatically:
...
class ImageCompressor:
    ...
    https://huggingface.co/SamirSengupta/technique-router

    Args:
        model_id: HuggingFace model ID (default: SamirSengupta/technique-router)
