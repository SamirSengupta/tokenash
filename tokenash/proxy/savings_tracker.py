...
survive proxy restarts and can be shared by multiple Tokenash frontends.
"""
...
TOKENASH_SAVINGS_PATH_ENV_VAR = _paths.TOKENASH_SAVINGS_PATH_ENV
DEFAULT_SAVINGS_DIR = ".tokenash"
...
def get_default_savings_storage_path() -> str:
    ...
    # Preserve legacy behavior: when TOKENASH_SAVINGS_PATH is set we return
    ...
    env_path = os.environ.get(TOKENASH_SAVINGS_PATH_ENV_VAR, "").strip()
    if env_path:
        return env_path
