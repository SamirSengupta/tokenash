"""AWS Bedrock ``InvokeModel`` passthrough handler for TokenashProxy.
...
through Tokenash's catch-all and were forwarded verbatim — no compression.
...
class BedrockHandlerMixin:
    ...
    async def handle_bedrock_invoke(
        ...
        *,
        ...
        bypass = (
            _tokenash_bypass_enabled(request.headers)
