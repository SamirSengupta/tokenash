...
Four key components:
1. Tool Injection: Proxy injects tokenash_retrieve tool into requests
...
try:
    from .mcp_server import TokenashMCPServer, create_ccr_mcp_server

    MCP_SERVER_AVAILABLE = True
except ImportError:
    TokenashMCPServer = None  # type: ignore
