"""LangGraph integration for Tokenash tool message compression.
...
Example:
    ...
    from tokenash.integrations.langchain.langgraph import (
...
def compress_tool_messages(
    ...
    *,
    ...
    Example:
        ...
        from tokenash.integrations.langchain.langgraph import compress_tool_messages
