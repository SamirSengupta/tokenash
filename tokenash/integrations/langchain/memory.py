...
This module provides TokenashChatMessageHistory, a wrapper for any LangChain
...
Example:
    ...
    compressed_history = TokenashChatMessageHistory(base_history)
...
class TokenashChatMessageHistory(BaseChatMessageHistory):
    ...
    Example:
        ...
        compressed = TokenashChatMessageHistory(
            base,
    ...
    def __init__(
        ...
        """Initialize TokenashChatMessageHistory.
        ...
        Args:
            ...
            model: Model name for token counting. Default "gpt-4o".
            provider: Tokenash provider for token counting. Auto-uses
    ...
    def messages(self) -> list[BaseMessage]:  # type: ignore[override]
        ...
        logger.info(
            f"TokenashChatMessageHistory compressed: {token_count} -> {tokens_after} tokens "
    ...
    def _apply_compression(self, messages: list[BaseMessage]) -> list[BaseMessage]:
        ...
        Returns:
            ...
            applicable.
        """
        # Convert to OpenAI format for Tokenash transforms
