...
This module provides TokenashDocumentCompressor, a LangChain BaseDocumentCompressor
...
class TokenashDocumentCompressor(BaseDocumentCompressor):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """Initialize TokenashDocumentCompressor.
    ...
    def compress_documents(
        ...
        logger.info(
            f"TokenashDocumentCompressor: {len(documents)} -> {len(final_docs)} documents "
