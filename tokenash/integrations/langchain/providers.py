...
class paths to identify the appropriate Tokenash provider.

Example:
    from langchain_anthropic import ChatAnthropic
    from tokenash.integrations.langchain import get_tokenash_provider
...
def get_tokenash_provider(model: Any) -> Provider:
    """Get appropriate Tokenash Provider instance for a LangChain model.

    This function automatically detects the provider from the model type
    and returns a configured Tokenash provider for accurate token counting
    ...
    Returns:
        Configured Tokenash Provider instance
    ...
    from tokenash.providers import (
        AnthropicProvider,
        GoogleProvider,
        OpenAIProvider,
    )
