...
Automatically detects the correct Tokenash provider based on the Agno model type.
"""
...
# Mapping from Agno model class names to Tokenash providers
...
def get_tokenash_provider(agno_model: Any) -> Provider:
    """Get the appropriate Tokenash provider for an Agno model.
    ...
    Example:
        ...
        provider = get_tokenash_provider(model)  # Returns OpenAIProvider
    """
