...
Mirrors the Anthropic OAuth usage API response exactly, including:
  ...
  - Tokenash contribution: tokens conserved by compression, CLI filtering, cache
...
# ---------------------------------------------------------------------------
# Tokenash contribution estimate
# ---------------------------------------------------------------------------


@dataclass
class TokenashContribution:
    """Tokens conserved within the current 5h window by Tokenash's layers.
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "raw_without_tokenash": self.raw_without_tokenash(),
...
class SubscriptionState:
    ...
    contribution: TokenashContribution = field(default_factory=TokenashContribution)
