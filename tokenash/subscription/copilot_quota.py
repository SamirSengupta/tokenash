...
come from the environment at tokenash start-up.
...
class _CopilotQuotaTracker(QuotaTracker):
    ...
    Implements :class:`~tokenash.subscription.base.QuotaTracker` so it can be
    registered with the :class:`~tokenash.subscription.base.QuotaTrackerRegistry`.
    ...
    async def _poll_loop(self) -> None:
        ...
        while not self._stop_event.is_set():
            ...
            try:
                ...
                # note in tokenash/subscription/tracker.py:_poll_loop.
