"""Embedding-based relevance scorer for Tokenash SDK.
...
class EmbeddingScorer(RelevanceScorer):
    ...
    Note:
        Requires fastembed: pip install tokenash[relevance]
    """
    ...
    def _get_model(self) -> TextEmbedding:
        ...
        if not self.is_available():
            raise RuntimeError(
                "EmbeddingScorer requires fastembed. Install with: pip install tokenash[relevance]"
            )
