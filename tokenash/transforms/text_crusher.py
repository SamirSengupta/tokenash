...
Thin Python wrapper over the native ``tokenash._core.TextCrusher``. The
algorithm (sentence scoring with the SHARED BM25 relevance scorer + global
word-shingle near-dup suppression) lives in Rust (``crates/tokenash-core``),
...
from tokenash._core import TextCrusher as _RustTextCrusher
from tokenash._core import TextCrusherConfig as _RustTextCrusherConfig
