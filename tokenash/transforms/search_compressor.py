...
`crates/tokenash-core/src/transforms/search_compressor.rs`. This module
...
class SearchCompressor:
    ...
    def _parse_search_results(self, content: str) -> dict[str, FileMatches]:
        ...
        from tokenash._core import parse_search_lines
    ...
    def _score_matches(
        ...
        """
        from tokenash.transforms.error_detection import PRIORITY_PATTERNS_SEARCH
    ...
    def _select_matches(
        ...
        from tokenash.transforms.adaptive_sizer import compute_optimal_k
