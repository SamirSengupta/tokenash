"""rtk (Rust Token Killer) integration for Tokenash.

rtk compresses CLI output (test results, git diffs, log dumps) before it
enters the LLM context window. Tokenash downloads and manages the rtk binary.
"""
...
def _managed_rtk_candidates() -> list[Path]:
    """Return known Tokenash-managed rtk binary paths."""
