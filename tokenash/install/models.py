...
class RuntimeKind(str, Enum):
    """Runtime used to execute Tokenash."""
...
class ManagedMutation:
    """A reversible change applied by `tokenash install`."""
...
class DeploymentManifest:
    ...
    image: str = "ghcr.io/samirsengupta/tokenash:latest"
    service_name: str = "tokenash"
    container_name: str = "tokenash-persistent"
