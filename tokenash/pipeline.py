"""Canonical Tokenash pipeline lifecycle and extension contracts."""
...
ENTRY_POINT_GROUP = "tokenash.pipeline_extension"


class PipelineStage(str, Enum):
    """Stable lifecycle stages for the canonical Tokenash pipeline."""
