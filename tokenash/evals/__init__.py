...
Install with: pip install tokenash[evals]

Quick start:
    from tokenash.evals import run_quick_eval
    results = run_quick_eval(n_samples=5)
    print(results.summary())

Batch compression eval:
    from tokenash.evals import run_batch_compression_eval
...
from tokenash.evals.runners.before_after import (
    BeforeAfterRunner,
    LLMConfig,
    run_quick_eval,
)
from tokenash.transforms.content_router import ContentRouterConfig
