"""Adversarial robustness grid for Tokenash compressors (offline, no LLM).
...
- abuse compressor control surfaces. Tokenash has a concrete instance:
...
# Tokenash-specific CCR marker spoof. benign_control anchors the baseline.
