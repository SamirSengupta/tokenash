...
def output_savings() -> None:
    ...
    if not path.exists():
        ...
        click.echo("Run `tokenash learn --verbosity --apply` to seed the baseline,")
        click.echo("then enable the shaper (TOKENASH_OUTPUT_SHAPER=1) and send traffic.")
        return
    ...
    if est.kind == "estimated":
        click.echo(
            ...
            "\n  set TOKENASH_OUTPUT_HOLDOUT=0.1 to leave 10% of conversations"
