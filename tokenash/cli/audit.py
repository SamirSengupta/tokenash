...
def audit_reads_cmd(
    ...
    \b
    Examples:
        tokenash audit-reads
        tokenash audit-reads --path /var/transcripts --format json
        tokenash audit-reads --codex
    """
    ...
    if codex_mode:
        ...
        from tokenash.audit.codex import audit_codex, render_codex_text
    ...
    if simulate_maturation:
        from tokenash.audit.maturation import render_sim_text
        from tokenash.audit.maturation import simulate_maturation as run_sim
