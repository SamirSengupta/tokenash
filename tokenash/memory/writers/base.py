...
Writers convert Tokenash memory entries into agent-specific file formats.
...
# Marker delimiters for Tokenash-managed sections (matches learn/writer.py)
MARKER_START = "<!-- tokenash:memory:start -->"
MARKER_END = "<!-- tokenash:memory:end -->"
