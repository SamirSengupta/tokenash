"""Memory wrapper - the main API for Tokenash Memory.
...
from tokenash.memory.inline_extractor import (
...
class MemoryWrapper:
    ...
    def __init__(
        ...
        client: Any,
        user_id: str,
        db_path: str | Path = "tokenash_memory.db",
        top_k: int = 5,
...
class _MemoryAPI:
    ...
    def get_all(self) -> list[Memory]:
        ...
        from tokenash.memory.ports import MemoryFilter
...
def with_memory(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        user_id: User identifier for memory isolation
        db_path: Path to SQLite database (default: tokenash_memory.db)
