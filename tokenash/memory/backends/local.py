"""Local backend adapter for Tokenash's hierarchical memory system.
...
from tokenash.memory.adapters.graph_models import Entity, Relationship, Subgraph
...
class LocalBackend:
    ...
    async def _ensure_initialized(self) -> None:
        ...
        if not self._initialized:
            ...
            from tokenash.memory.config import EmbedderBackend
    ...
    async def text_search(
        ...
        from tokenash.memory.ports import TextFilter
