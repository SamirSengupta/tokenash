"""Tokenash Memory - Simple, zero-config memory for AI applications.

Quick Start (No Docker Required):
    from tokenash.memory import Memory
...
Advanced Usage - LLM Wrapper:
    ...
    from tokenash.memory import with_memory
...
Advanced Usage - Tool-based:
    from openai import OpenAI
    from tokenash.memory import with_memory_tools, LocalBackend
...
# Graph adapters
# =============================================================================
from tokenash.memory.adapters.graph import InMemoryGraphStore
...
# =============================================================================
# Memory Bridge (markdown <-> Tokenash bidirectional sync)
# =============================================================================
from tokenash.memory.bridge import ImportStats, MemoryBridge, SyncStats
from tokenash.memory.bridge_config import BridgeConfig, MarkdownFormat
from tokenash.memory.config import (
    EmbedderBackend,
    MemoryConfig,
    StoreBackend,
    TextBackend,
...
# Core orchestrator
# =============================================================================
from tokenash.memory.core import HierarchicalMemory

# =============================================================================
# Simple API (recommended for most users)
# =============================================================================
from tokenash.memory.easy import Memory, MemoryResult

# =============================================================================
# Factory
# =============================================================================
from tokenash.memory.factory import create_memory_system

# =============================================================================
# Data models (internal)
# =============================================================================
from tokenash.memory.models import Memory as MemoryModel
from tokenash.memory.models import ScopeLevel

# =============================================================================
# Protocol interfaces (ports)
# =============================================================================
from tokenash.memory.ports import (
    # Core protocols
    Embedder,
    # Graph dataclasses
    Entity,
...
# =============================================================================
from tokenash.memory.system import MemoryBackend, MemorySystem

# =============================================================================
# Memory tools for LLM function calling
# =============================================================================
from tokenash.memory.tools import (
    MEMORY_TOOLS,
...
# =============================================================================
from tokenash.memory.wrapper import MemoryWrapper, with_memory

# =============================================================================
# Tool-based wrapper for LLM clients
# =============================================================================
from tokenash.memory.wrapper_tools import MemoryToolsWrapper, with_memory_tools
...
def __getattr__(name: str) -> type:
    ...
    if name == "Mem0Backend":
        if _Mem0Backend is None:
            from tokenash.memory.backends.mem0 import Mem0Backend
    ...
    if name == "DirectMem0Adapter":
        if _DirectMem0Adapter is None:
            from tokenash.memory.backends.direct_mem0 import DirectMem0Adapter
    ...
    if name == "DirectMem0Config":
        if _DirectMem0Config is None:
            from tokenash.memory.backends.direct_mem0 import Mem0Config as DirectMem0Config
