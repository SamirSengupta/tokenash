...
from tokenash.providers.codex import proxy_base_url as codex_proxy_base_url
from tokenash.proxy.project_context import with_project_prefix
...
def build_launch_env(
    ...
    as a JSON array. When routing through Tokenash, we set the mistral provider's
    ...
    # NOTE: With a persistent Tokenash deployment (`tokenash install`), the proxy
    ...
    # Build the providers JSON with mistral provider pointing to Tokenash proxy
