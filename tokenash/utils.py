"""Shared utilities for Tokenash SDK."""
...
# Marker format for Tokenash modifications
MARKER_PREFIX = "<tokenash:"
MARKER_SUFFIX = ">"
...
def create_marker(marker_type: str, **kwargs: Any) -> str:
    """
    Create a Tokenash marker string.
...
def extract_markers(text: str) -> list[dict[str, Any]]:
    """
    Extract Tokenash markers from text.

    Returns:
        List of dicts with marker_type and attributes.
    """
    pattern = re.compile(r"<tokenash:(\w+)([^>]*)>")
    markers = []
