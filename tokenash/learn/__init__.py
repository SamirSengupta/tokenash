"""Tokenash Learn — offline session learning for coding agents.
...
Built-in plugins are auto-discovered from tokenash.learn.plugins.*.
External plugins register via the ``tokenash.learn_plugin`` entry point.
"""
