"""Base class for tokenash learn plugins.
...
class LearnPlugin(ABC):
    ...
    Plugins are discovered automatically from tokenash.learn.plugins.*
    or via ``tokenash.learn_plugin`` entry points for external packages.
