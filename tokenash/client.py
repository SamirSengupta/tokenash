"""Main TokenashClient implementation for Tokenash SDK."""
...
class ChatCompletions:
    ...
    def __init__(self, client: TokenashClient):
        self._client = client
    ...
    def create(
        ...
        *,
        ...
        stream: bool = False,
        # Tokenash-specific parameters
        tokenash_mode: str | None = None,
        tokenash_cache_prefix_tokens: int | None = None,
        tokenash_output_buffer_tokens: int | None = None,
        tokenash_keep_turns: int | None = None,
        tokenash_tool_profiles: dict[str, dict[str, Any]] | None = None,
        # Pass through all other kwargs
        **kwargs: Any,
    ) -> Any:
        """
        Create a chat completion with optional Tokenash optimization.

        Args:
            model: Model name.
            messages: List of messages.
            stream: Whether to stream the response.
            tokenash_mode: Override default mode ("audit" | "optimize").
            tokenash_cache_prefix_tokens: Target cache-aligned prefix size.
            tokenash_output_buffer_tokens: Reserve tokens for output.
            tokenash_keep_turns: Never drop last N turns.
            tokenash_tool_profiles: Per-tool compression config.
        ...
        return self._client._create(
            ...
            messages=messages,
            stream=stream,
            tokenash_mode=tokenash_mode,
            tokenash_cache_prefix_tokens=tokenash_cache_prefix_tokens,
            tokenash_output_buffer_tokens=tokenash_output_buffer_tokens,
            tokenash_keep_turns=tokenash_keep_turns,
            tokenash_tool_profiles=tokenash_tool_profiles,
            api_style="openai",
            **kwargs,
        )
    ...
    def simulate(
        ...
        **kwargs: Any,
        ...
        Args:
            model: Model name.
            messages: List of messages.
            tokenash_mode: Mode to simulate.
            tokenash_output_buffer_tokens: Output buffer to use.
            tokenash_tool_profiles: Tool profiles to use.
...
class Messages:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """
        Create a message with optional Tokenash optimization.
    ...
    def stream(
        ...
        **kwargs: Any,
        ...
        """
        Stream a message with optional Tokenash optimization.
...
class TokenashClient:
    ...
    def __init__(
        ...
        Args:
            ...
            config: Optional TokenashConfig for full control over all settings.
        ...
        if store_url is None:
            ...
            db_path = os.path.join(tempfile.gettempdir(), "tokenash.db")
            store_url = f"sqlite:///{db_path}"

        self._store_url = store_url
        self._default_mode = TokenashMode(default_mode)
    ...
    def _create(
        ...
        **kwargs: Any,
        ...
        mode = TokenashMode(tokenash_mode) if tokenash_mode else self._default_mode
        ...
        if mode == TokenashMode.OPTIMIZE:
            output_buffer = tokenash_output_buffer_tokens or self._config.output_buffer_tokens
            ...
            result = self._pipeline.apply(
                ...
                tool_profiles=tokenash_tool_profiles or {},
            )
    ...
    def __enter__(self) -> TokenashClient:
    ...
    def validate_setup(self) -> dict[str, Any]:
        """Validate that Tokenash is properly configured.
        ...
        try:
            # Check mode is valid
            if self._default_mode in (TokenashMode.AUDIT, TokenashMode.OPTIMIZE):
